...
#[test]
fn json_tcp_port_1_stderr_empty() {
...
#[test]
fn csv_tcp_port_1_stderr_empty() {
...
#[test]
fn json_udp_port_1_stderr_empty() {
...
#[test]
fn csv_udp_port_1_stderr_empty() {
...
#[test]
fn json_4tcp_port_1_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4TCP:1"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4tcp_port_1_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4TCP:1"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4udp_port_1_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4UDP:1"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4udp_port_1_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4UDP:1"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6tcp_port_1_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6TCP:1"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6tcp_port_1_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6TCP:1"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6udp_port_1_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6UDP:1"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6udp_port_1_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6UDP:1"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_tcp_port_2_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "TCP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_tcp_port_2_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "TCP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_udp_port_2_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "UDP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_udp_port_2_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "UDP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4tcp_port_2_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4TCP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4tcp_port_2_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4TCP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4udp_port_2_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4UDP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4udp_port_2_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4UDP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6tcp_port_2_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6TCP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6tcp_port_2_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6TCP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6udp_port_2_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6UDP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6udp_port_2_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6UDP:2"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_tcp_port_3_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "TCP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_tcp_port_3_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "TCP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_udp_port_3_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "UDP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_udp_port_3_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "UDP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4tcp_port_3_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4TCP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4tcp_port_3_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4TCP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4udp_port_3_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4UDP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4udp_port_3_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4UDP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6tcp_port_3_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6TCP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6tcp_port_3_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6TCP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6udp_port_3_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6UDP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6udp_port_3_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6UDP:3"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_udp_port_22_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "UDP:22"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_udp_port_22_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "UDP:22"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn csv_4tcp_port_22_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4TCP:22"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4udp_port_22_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4UDP:22"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4udp_port_22_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4UDP:22"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6udp_port_22_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6UDP:22"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6udp_port_22_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6UDP:22"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6tcp_port_67_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6TCP:67"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6tcp_port_67_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6TCP:67"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_6tcp_port_123_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6TCP:123"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6tcp_port_123_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "6TCP:123"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4tcp_port_67_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4TCP:67"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4tcp_port_67_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4TCP:67"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4udp_port_123_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4UDP:123"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4udp_port_123_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4UDP:123"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4tcp_port_123_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4TCP:123"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4tcp_port_123_stderr_empty() {
    let out = lsofrs().args(["--csv", "-i", "4TCP:123"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let stdout = String::from_utf8_lossy(&out.stdout);
    let first = stdout.lines().next().unwrap_or("");
...
#[test]
fn json_4tcp_port_65535_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4TCP:65535"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4tcp_port_65535_stderr_empty() {
    let out = lsofrs()
        .args(["--csv", "-i", "4TCP:65535"])
        .output()
        .unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
...
#[test]
fn json_6tcp_port_65535_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6TCP:65535"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6tcp_port_65535_stderr_empty() {
    let out = lsofrs()
        .args(["--csv", "-i", "6TCP:65535"])
        .output()
        .unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
...
#[test]
fn json_4udp_port_65535_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "4UDP:65535"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_4udp_port_65535_stderr_empty() {
    let out = lsofrs()
        .args(["--csv", "-i", "4UDP:65535"])
        .output()
        .unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
...
#[test]
fn json_6udp_port_65535_stderr_empty() {
    let out = lsofrs().args(["-J", "-i", "6UDP:65535"]).output().unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
    let v: serde_json::Value = serde_json::from_str(&String::from_utf8_lossy(&out.stdout)).unwrap();
    assert!(v.is_array());
...
#[test]
fn csv_6udp_port_65535_stderr_empty() {
    let out = lsofrs()
        .args(["--csv", "-i", "6UDP:65535"])
        .output()
        .unwrap();
    assert!(out.status.success());
    assert!(out.stderr.is_empty());
