//! Binary dispatch for the `lsofrs` / `lsf` / `lsof` entry points.
//!
//! The whole CLI flow lives here rather than in `main.rs` so that alias crates
...
mod tests {
    use super::*;
    use crate::types::{OpenFile, Process};
